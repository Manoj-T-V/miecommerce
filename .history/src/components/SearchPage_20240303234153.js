...
function filterdata(data, query) {
  ...
  Object.keys(data).forEach(category => {
    if (category === "miPhones" || category === "tv" || category === "redmiPhones" || category === "laptop" || category === "fitnessAndLifeStyle" || category === "fitnessAndLifeStyle" || category === "fitnessAndLifeStyle" ||) {
